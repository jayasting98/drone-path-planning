...
from drone_path_planning.models import MultipleChasersSingleTargetGraphQNetwork


@tf.keras.utils.register_keras_serializable('dpp.agents', 'cn_t1_agent')
class MultipleChasersSingleTargetAgent(DeepQNetworkAgent):
    def __init__(
        self,
    ...
    def _create_model(self) -> tf.keras.Model:
        model = MultipleChasersSingleTargetGraphQNetwork(
